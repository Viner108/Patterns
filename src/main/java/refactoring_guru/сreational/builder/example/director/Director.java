package refactoring_guru.сreational.builder.example.director;

import refactoring_guru.сreational.builder.example.builders.Builder;
...
public class Director {
    public void constructSportsCar(Builder builder){
        ...
        builder.setTransmission(Transmission.SEMI_AUTOMATTIC);
    ...
    public void constructCityCar(Builder builder){
        ...
        builder.setTransmission(Transmission.AUTOMATTIC);
        builder.setTripComputer(new TripComputer());
        builder.setGPSNavigator(new GPSNavigator());
    }
